...
### Bước 1: Đăng ký & Định danh (Onboarding)
...
### Bước 2: Khám phá Bảng tin (Project Feed)
...
### Bước 3: Đăng tải Dự án mới (Create Post)
...
### Bước 5: Quản lý Tin nhắn & Kết nối (Messaging)
...
### Bước 6: Quản lý Dự án cá nhân (Manage Projects)
...
### Bước 7: AI Hub & Tiện ích mở rộng
- Trang **AI Hub (/ai-hub)**: Nơi tích hợp các tiện ích AI, ví dụ như tự động sinh mô tả dự án từ vài từ khóa, hoặc phân tích kỹ năng để gợi ý dự án phù hợp nhất.
...
## 5. Kiến trúc Hệ thống & Cơ sở dữ liệu (Database Design)
